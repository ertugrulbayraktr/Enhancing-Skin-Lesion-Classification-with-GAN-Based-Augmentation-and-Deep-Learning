...
const ImageProcessingPreview = ({ originalImage, processedImage }) => {
  ...
  return (
    <div className="mt-6 p-4 md:p-6 bg-gradient-to-r from-primary/5 to-accent-teal/5 rounded-xl border border-primary/20">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="grid grid-cols-2 gap-3 md:gap-6">
          ...
          <div className="space-y-2">
            <p className="text-xs md:text-sm font-medium text-slate-600 text-center">Original</p>
            <div className="relative rounded-lg overflow-hidden border-2 border-slate-200 aspect-square">
              <img
                src={originalImage}
                alt="Original"
          ...
          <div className="space-y-2">
            ...
            <div className="relative rounded-lg overflow-hidden border-2 border-primary aspect-square">
              <img
                ...
                className="w-full h-full object-cover"
              />
              <div className="absolute top-1 right-1 md:top-2 md:right-2 px-2 py-0.5 md:py-1 bg-primary text-white text-xs font-semibold rounded">
                Processed
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-center mt-3">
          <div className="flex items-center gap-2 px-3 py-1 bg-white/50 rounded-full">
            ...
            <span className="text-xs text-slate-600 font-medium">Preprocessed</span>
          </div>
        </div>
      </div>
