          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-800">Overview</h3>
              </div>
              <p className="text-slate-600 leading-relaxed">
                This web application uses deep learning to classify skin lesions into 5 different categories.
                Built with state-of-the-art {MODEL_INFO.fullName} architecture, it achieves {MODEL_INFO.accuracy}%
                accuracy on the HAM10000 dataset.
              </p>
            </div>
            ...
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-800">Technology</h3>
              </div>
              <div className="space-y-2 text-slate-600">
                ...
                <p><span className="font-semibold">Model:</span> {MODEL_INFO.fullName}</p>
                <p><span className="font-semibold">Preprocessing:</span> Hair removal (OpenCV)</p>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-800">Purpose</h3>
              </div>
              <p className="text-slate-600 leading-relaxed">
